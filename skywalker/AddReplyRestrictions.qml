...
Dialog {
            ...
            Repeater {
                ...
                Row {
                    ...
                    PagingComboBox {
                        ...
                        model: SkyRoot.skywalker().getListListModel(restrictionDialog.listModelId)
                        valueRole: "listUri"
                        textRole: "listName"
                        inProgress: SkyRoot.skywalker().getListListInProgress
                        bottomOvershootFun: () => SkyRoot.skywalker().getListListNextPage(restrictionDialog.listModelId)
    ...
    Component.onCompleted: {
        ...
        if (rootUri) {
            ...
            isThreadFromUser = Boolean(did === SkyRoot.skywalker().getUserDid())
        }
