...
SkyPage {
            ...
            Avatar {
                ...
                onClicked:  {
                    if (page.authorAvatar)
                        SkyRoot.root.viewFullImage([page.author.imageView], 0)
                }
            }
        }
    }
    ...
    ListView {
        ...
        header: Column {
            ...
            RowLayout {
                ...
                SvgButton {
                    ...
                    Menu {
                        ...
                        AccessibleMenuItem {
                            ...
                            onTriggered: SkyRoot.root.translateText(page.authorDescription)

                            MenuItemSvg { svg: SvgOutline.googleTranslate }
                        }
                        AccessibleMenuItem {
                            text: qsTr("Share")
                            onTriggered: page.skywalker.shareAuthor(page.author)

                            MenuItemSvg { svg: SvgOutline.share }
                        }
                        AccessibleMenuItem {
                            text: page.following ? qsTr("Unfollow") : qsTr("Follow")
                            visible: page.isLabeler && !page.isUser(page.author) && page.contentVisible()
                            onClicked: {
                                if (page.following)
                                    graphUtils.unfollow(page.author.did, page.following)
                                else
                                    graphUtils.follow(page.author)
                            }
                        ...
                        AccessibleMenuItem {
                            text: qsTr("Search")
                            onTriggered: SkyRoot.root.viewSearchView("", page.author.handle)
                        ...
                        AccessibleMenuItem {
                            ...
                            visible: !page.isUser(page.author)
                            onTriggered: SkyRoot.root.reportAuthor(page.author)
                ...
                SvgButton {
                    ...
                    onClicked: page.skywalker.chat.startConvoForMember(page.author.did)
                    visible: page.author.canSendDirectMessage() && !page.isUser(page.author) && !page.skywalker.chat.messageConvoOpen()
                }
            ...
            AccessibleText {
                ...
                topPadding: 10
                color: guiSettings.textColor
                text: qsTr(`🗓 First appearance: ${page.firstAppearanceDate}`)
                visible: page.contentVisible()
            }
            ...
            RowLayout {
                ...
                function showKnownFollowers() {
                    let modelId = SkyRoot.root.getSkywalker().createAuthorListModel(QEnums.AUTHOR_LIST_KNOWN_FOLLOWERS, author.did)
                    SkyRoot.root.viewAuthorList(modelId, qsTr(`Followers you follow`));
                }
            }
        ...
        delegate: StackLayout {
            ...
            ListView {
                ...
                header: ColumnLayout {
                    ...
                    AccessibleText {
                        ...
                        wrapMode: Text.Wrap
                        color: guiSettings.textColor
                        text: qsTr(`Subscribe to ${page.author.handle} to use these labels`)
            ...
            AuthorPostsList {
                ...
                author: page.author
                enclosingView: authorFeedView
                getFeed: (id) => page.skywalker.getAuthorLikes(id)
                getFeedNextPage: (id) => page.skywalker.getAuthorLikesNextPage(id)
                getEmptyListIndicationSvg: () => page.getEmptyListIndicationSvg()
                getEmptyListIndicationText: () => page.getEmptyListIndicationText()
                visibilityShowProfileLink: (list) => page.visibilityShowProfileLink(list)
                disableWarning: () => page.disableWarning()
            ...
            ListView {
                ...
                clip: true
                spacing: 0
                model: page.skywalker.getFeedListModel(page.feedListModelId)
                flickDeceleration: guiSettings.flickDeceleration
                maximumFlickVelocity: guiSettings.maxFlickVelocity
                pixelAligned: guiSettings.flickPixelAligned
                ScrollIndicator.vertical: ScrollIndicator {}
                ...
                FlickableRefresher {
                    inProgress: page.skywalker.getFeedInProgress
                    bottomOvershootFun: () => page.getFeedListNextPage(page.feedListModelId)
                }

                BusyIndicator {
                    anchors.centerIn: parent
                    running: page.skywalker.getFeedInProgress
                }
                ...
                function refresh() {
                    page.getFeedList(page.feedListModelId)
                }
            ...
            ListView {
                ...
                clip: true
                spacing: 0
                model: page.skywalker.getStarterPackListModel(page.starterPackListModelId)
                flickDeceleration: guiSettings.flickDeceleration
                maximumFlickVelocity: guiSettings.maxFlickVelocity
                pixelAligned: guiSettings.flickPixelAligned
                ScrollIndicator.vertical: ScrollIndicator {}
                ...
                FlickableRefresher {
                    inProgress: page.skywalker.getStarterPackListInProgress
                    bottomOvershootFun: () => page.getStarterPackListNextPage(page.starterPackListModelId)
                }

                BusyIndicator {
                    anchors.centerIn: parent
                    running: page.skywalker.getStarterPackListInProgress
                }
                ...
                function refresh() {
                    page.getStarterPackList(page.starterPackListModelId)
                }
            ...
            ListView {
                ...
                clip: true
                spacing: 0
                model: page.skywalker.getListListModel(page.listListModelId)
                flickDeceleration: guiSettings.flickDeceleration
                maximumFlickVelocity: guiSettings.maxFlickVelocity
                pixelAligned: guiSettings.flickPixelAligned
                ScrollIndicator.vertical: ScrollIndicator {}
                ...
                FlickableRefresher {
                    inProgress: page.skywalker.getListListInProgress
                    bottomOvershootFun: () => page.getListListNextPage(page.listListModelId)
                }

                BusyIndicator {
                    anchors.centerIn: parent
                    running: page.skywalker.getListListInProgress
                }
                ...
                function refresh() {
                    page.getListList(page.listListModelId)
                }
    ...
    GraphUtils {
        ...
        onMuteRepostsOk: {
            authorMutedReposts = graphUtils.areRepostsMuted(page.author.did)
            authorFeedView.refresh()
        }
